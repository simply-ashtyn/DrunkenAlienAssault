#include "DXRendererLogic.h"

bool DXRendererLogic::Init(	std::shared_ptr<flecs::world> _game, 
								...
								GW::SYSTEM::GWindow _window)
{
	...
	//if (LoadShaders() == false)    Shouldnt Need this, being handled in renderer
		//return false;
	//if (LoadUniforms() == false)   Not sure what this would accomplish
		//return false;
	//if (LoadGeometry() == false)   Shouldnt need this, being handled in loadObjectOriented
		//return false;
	...
	shutdown.Create(DXSurface, [&]() {});
	return true;
}

bool DXRendererLogic::Activate(bool runSystem)
{
...
std::string DXRendererLogic::ShaderAsString(const char* shaderFilePath)
{
	std::string output;
...
bool DXRendererLogic::LoadShaders()
{

	//Shouldnt Need this function, its being handled in Renderer
...
//	DXSurface.GetDevice((void**)&device);
...
//bool DXRendererLogic::LoadUniforms()
//{
//	ID3D11Device* device = nullptr;
//	IDXGIAdapter* physicalDevice = nullptr;
//	DXSurface.GetDevice((void**)&device);
//	DXSurface.GetPhysicalDevice((void**)&physicalDevice);
//
...
//bool DXRendererLogic::LoadGeometry()
//{
//	ID3D11Device* device = nullptr;
...
//bool DXRendererLogic::SetupPipeline()
//{
//	ID3D11Device* device = nullptr;
...
//}
//
//bool DXRendererLogic::SetupDrawcalls() // I SCREWED THIS UP MAKES SO MUCH SENSE NOW
//{
...
//}
//
//bool DXRendererLogic::FreeVulkanResources()
//{
//	ID3D11Device* device = nullptr;
//	vulkan.GetDevice((void**)&device);
